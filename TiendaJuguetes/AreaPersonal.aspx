<%@ Page Title="" Language="C#" MasterPageFile="~/TiendaJuguetesMaster.Master" AutoEventWireup="true" CodeBehind="AreaPersonal.aspx.cs" Inherits="TiendaJuguetes.WebForm4" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="form-login">
        <asp:Button class="botons" ID="Button1" runat="server" Text="Cambiar Usuario" OnClick="Button1_Click" />
        &nbsp;&nbsp;&nbsp;
        <asp:Button class="botons" ID="Button2" runat="server" Text="Cambiar Contraseña" OnClick="Button2_Click" />
        &nbsp;&nbsp;&nbsp;
        <asp:Button class="botons" ID="Button3" runat="server" Text="Cambiar Direccion" OnClick="Button3_Click" />
    </section>
    <!--
    <section class="form-register">
        ...
        <asp:TextBox class ="controls" ID="TextBoxContrasena" placeholder="Introduzca Contraseña" runat="server"></asp:TextBox>
        ...
        <asp:Button class="botons" ID="BtnRegistr" runat="server" Text="Registrar" />
