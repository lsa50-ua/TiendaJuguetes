<%@ Page Title="" Language="C#" MasterPageFile="~/TiendaJuguetesMaster.Master" AutoEventWireup="true" CodeBehind="Categoria.aspx.cs" Inherits="TiendaJuguetes.WebForm9" %>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <link rel="stylesheet" href="estilosCategoria.css" />
    <div id="orderSelector" class ="orderSelector">
            Ordenar por:
            <asp:DropDownList ID="OrdenarPor" Width="95%" CssClass="orderSelector" runat="server" align="right" AutoPostBack="true" OnSelectedIndexChanged="onOrdenar">
